...
public class JudgeMetrics {
    ...
    private final Timer judgeTotalTimer;
    private final Timer judgeSubmitTimer;
    private final Timer problemQueryTimer;
    private final Timer testCaseQueryTimer;
    private final Timer redisLimitTimer;
    private final Timer mqSendTimer;
    private final Timer judge0CallTimer;
    private final Timer redisUpdateTimer;
    private final Timer databaseUpdateTimer;
    private final Timer websocketPushTimer;
