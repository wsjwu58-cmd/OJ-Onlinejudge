package com.oj.judge.controller.admin;
...
public class MaliciousCodeController {
    ...
    public Result<MaliciousCodeStats> getStats(
        ...
        long javaCount = allLogs.stream().filter(l -> "java".equalsIgnoreCase(l.getLanguage())).count();
        long pythonCount = allLogs.stream().filter(l -> "python".equalsIgnoreCase(l.getLanguage())).count();
        long cppCount = allLogs.stream().filter(l -> "cpp".equalsIgnoreCase(l.getLanguage()) || "c++".equalsIgnoreCase(l.getLanguage())).count();
